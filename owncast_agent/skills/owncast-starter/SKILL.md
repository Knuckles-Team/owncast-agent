---
name: owncast-starter
description: >-
  Owncast API + MCP Server + A2A Server Use when working with Owncast via this package's MCP
...
license: MIT
tags: [owncast-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Owncast Starter Skill

Starter skill for the **Owncast** package. Use the `mcp-client` universal skill
